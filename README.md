...
So, the only thing you need to do, is to upload the SQL-dump to your localhost, and you can run the Project right from the **index.html** page.
This requires a PHP5 WAMP server with phpmyadmin usage. On the import page you can give in the file URL, and then it's alright. Some date is included, so you can use it.
...
Two additional JS Libraries are involved: Datepicker, and TimePicker from Protoplasm.
